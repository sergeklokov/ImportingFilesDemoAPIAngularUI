...
- Create Angular project with ng: `ng new importingfilesdemoapiangularui.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`importingfilesdemoapiangularui.client.esproj`).
